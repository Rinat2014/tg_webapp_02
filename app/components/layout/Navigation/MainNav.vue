...
<div class="fixed bottom-0 left-0 right-0 z-40">
  <ul class="bg-blue-900/95 h-20 text-xl   flex justify-around items-center ">
    <li><NuxtLink  class="text-white hover:bg-blue-500   dark:hover:bg-blue  p-5 rounded" to="/">Home</NuxtLink></li>
